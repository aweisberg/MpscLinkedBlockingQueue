...
public final class MpscLinkedQueue2 extends AtomicReference<OneTimeTask> implements Queue<Runnable> {
    ...
    static {
        try {
            tailOffset = unsafe.objectFieldOffset(
                    MpscLinkedQueue2.class.getDeclaredField("tail"));
        } catch (Throwable t) {
    ...
    public Runnable poll() {
        ...
        unsafe.putOrderedObject(this, tailOffset, next);
    ...
    private OneTimeTask peekTask() {
        for (;;) {
            final OneTimeTask tail = (OneTimeTask) unsafe.getObjectVolatile(this, tailOffset);
